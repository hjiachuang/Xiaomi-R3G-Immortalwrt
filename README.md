...
- 自行搭建开发环境，创建自己的 `.config` 文件
  - 本项目使用的是[Immortalwrt](https://github.com/immortalwrt/immortalwrt)源码，分支是`openwrt-24.10`
...
- 根据自己的需要修改脚本: `diy-part1.sh`和`diy-part2.sh`
...
- Set up a development environment by yourself and create your own `.config` file
  - This project utilizes the source code of [Immortalwrt](https://github.com/immortalwrt/immortalwrt), with the branch being `openwrt-24.10`
...
- Modify the scripts according to your needs: `diy-part1.sh` and `diy-part2.sh`
